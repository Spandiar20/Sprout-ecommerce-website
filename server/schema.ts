...
export const users = pgTable("user", {
  ...
  export const productsVariantsRelations = relations(productVariants, ({ many, one}) => ({
  ...
  export const variantsImagesRelations = relations(variantImages, ({ one }) => ({
  ...
  export const variantsTagsRelations = relations(variantTags, ({ one }) => ({
    productVariants: one(productVariants, {
